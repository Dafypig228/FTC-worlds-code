...
@Config
@Autonomous(name = "AutoFarFromGoalWithGateMinus1cycle", group = "Competition")
public class AutoFarFromGoalWithGateMinus1cycle extends OpMode {
    ...
    private Pose intakeHumanZonePose = new Pose(4, -65.75, Math.toRadians(-90));
