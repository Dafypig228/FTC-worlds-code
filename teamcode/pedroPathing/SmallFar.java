...
@Config
@Autonomous(name = "SmallFieldFar", group = "Competition")
public class SmallFar extends OpMode {
    private boolean allianceBlue = true;
    ...
    double ShootVel = 1600, RazgonVel = 900, FlyWheelVelocity = 1000, Static = 1700;

    private Pose startPose = new Pose(20, -9, Math.toRadians(-90));
    private Pose scorePose = new Pose(20, -9, Math.toRadians(-90));

    private Pose intakeHumanZonePose = new Pose(20, -12, Math.toRadians(-90));
    private Pose intakeGateZonePose = new Pose(20, -12, Math.toRadians(-90));
    private Pose leavePose = new Pose(20,-9, Math.toRadians(-90));
    ...
    private void recalculatePoses() {
        goal = new Vector2d(goal.x, (allianceBlue? -goal.y - 6.5: goal.y));
