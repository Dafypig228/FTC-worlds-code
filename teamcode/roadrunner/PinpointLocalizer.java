...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1406.5591314301446; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2600.126184647503; // x position of the perpendicular encoder (in tick units)
    }
