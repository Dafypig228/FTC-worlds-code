...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2131.35477; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2131.35477; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2333.114727161775; // x position of the perpendicular encoder (in tick units)
//        public double par0YTicks = 2093.450376970307; // y position of the first parallel encoder (in tick units)
//        public double par1YTicks = -2169.2591577551707; // y position of the second parallel encoder (in tick units)
//        public double perpXTicks = -2333.114727161775; // x position of the perpendicular encoder (in tick units)
    }
