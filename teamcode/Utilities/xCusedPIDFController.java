 ...
 */
public class xCusedPIDFController {
     ...
     */
    public xCusedPIDFController(double kp, double ki, double kd, double kf) {
     ...
     */
    public xCusedPIDFController(double kp, double ki, double kd, double kf, double sp, double pv) {
        kP = kp;
        kI = ki;
        kD = kd;
        kF = kf;
